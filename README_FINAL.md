...
# Run app
streamlit run probit\_web\_app\_final.py
```
...
* [**CHECKLIST\_COMPLETION\_GUIDE.md**](CHECKLIST_COMPLETION_GUIDE.md) - USDA publication requirements
* [**R\_SQUARED\_SLOPE\_ANALYSIS\_GUIDE.md**](R_SQUARED_SLOPE_ANALYSIS_GUIDE.md) - Biological interpretation guide
* [**FUNCTION\_FIX\_SUMMARY.md**](FUNCTION_FIX_SUMMARY.md) - Technical fixes and security improvements
* [**QUICK\_DEPLOYMENT\_GUIDE.md**](QUICK_DEPLOYMENT_GUIDE.md) - Deployment instructions
...
This software was developed by the U.S. Department of Agriculture, Agricultural Research Service (USDA ARS). As a work of the United States Government, this software is in the public domain within the United States.

Additionally, USDA ARS waives copyright and related rights in the work worldwide through the CC0 1.0 Universal Public Domain Dedication.

### License Terms

* **License**: Public Domain (CC0 1.0 Universal)
* **Cost**: Free for all users (academic, commercial, government)
* **Restrictions**: None (public domain software)
* **Attribution**: Requested but not required

### Disclaimer

This software is provided by the USDA Agricultural Research Service. The U.S. Government retains rights to this software. Use of this software does not constitute an endorsement by USDA-ARS of any commercial product or service.

See [LICENSE](LICENSE) file for complete legal details.
